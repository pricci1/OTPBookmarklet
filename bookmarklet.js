(async function() {
	...
	const totpSecretEncrypted = "redacted"

	const password = prompt("Password", "");
	const totpSecret = await aesGcmDecrypt(totpSecretEncrypted, password);
	const code = new jsOTP.totp().getOtp(totpSecret);

	document.querySelector("#totpPin").value = code;
